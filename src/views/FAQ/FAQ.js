  ...
  return (  
    <>
      ...
      <MDBAccordion alwaysOpen initialActive={1}>
        ...
        <MDBAccordionItem collapseId={3} headerTitle="Can I use Lightroom presets on my mobile device?">
        ...
        <MDBAccordionItem collapseId={3} headerTitle="Do I need Adobe Lightroom to use these presets?">
        ...
        <MDBAccordionItem collapseId={3} headerTitle="Can I customize the presets to suit my own style?">
